                  ...
                  <div class="footer-contact">
                    <p>
                      <a class="d-block" href="index.html">
                        <img
                          class="w__100 mb__15 lz_op_ef lazyload max-width__95px"
                          ...
                          alt="Kalles Template" data-src="assets/images/svg/kalles.svg">
                      </a>
                    </p>
                    <p>
                      <i class="pegk pe-7s-map-marker"> </i><span>184 Main Rd E, St Albans <br> <span class="pl__30">VIC
                        3021, Australia</span></span>
                    </p>
            ...
            <div class="col-lg-3 col-md-6 col-12 mb__50 order-lg-5 order-1">
              <div class="widget widget_text">
                ...
                <div class="widget_footer newl_des_1">
                    ...
                    <div class="mc4wp-form-fields">
                      <div class="signup-newsletter-form row no-gutters pr oh">
                        <div class="col col_email">
                          <input
                            type="email" name="email" placeholder="Your email address" value=""
                            class="tc tl_md input-text" required="required" />
                        </div>
                        <div class="col-auto">
                  ...
                  <p class="mt__20">
                    <img
                      class="w__100 lz_op_ef lazyload w__max-width__197" data-src="assets/images/payment2.png"
        ...
        <div class="container pr tc">
          <div class="row">
            <div class="col-lg-6 col-md-12 col-12 col_1">Copyright © 2021
              <span class="cp">Kalles</span> all rights reserved. Powered by<a href="#"> The4</a>
            </div>
