...
<template>
  <div :key="componentId" class="uploader-image-wrapper">
    <label v-if="!cropper.output" :for="identity" class="border">
      <FontAwesomeIcon :icon="['far', 'image']" />
      <input :id="identity" type="file" name="upload" :accept="localAccept" @change="onHandleChange">
    </label>

    <div v-else class="preview-wrapper">
      <img :src="cropper.output" class="image-preview" alt="Output after crop and resize">
